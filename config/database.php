<?php
	...
	//Deployment Connection for Clever Cloud
	//update 1: can't make user???
	//update 2: forced heroku apache to print out errors, swiftmailer and the bot acc was the reason(db connection fixed)
