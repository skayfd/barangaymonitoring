			    	...
			    	?>
				   		...
				   		<div class="row">
				   			<div class="col-md-12">
							    ...
							    <input type="text" name="middlename" class="form-control form-control-sm" pattern="[A-Za-z]{3,}" placeholder="Optional" value='<?php echo isset($_POST['middlename']) ? $_POST['middlename'] : '' ?>'>
				   			</div>
				   		</div>
				   		<div class="row">
				   			<div class="col-md-12">
				   				<label class="col-form-label col-form-label-sm">Last Name</label>
							    <input type="text" name="lastname" class="form-control form-control-sm" pattern="[A-Za-z]{3,}" title="3 or more letters required" value='<?php echo isset($_POST['lastname']) ? $_POST['lastname'] : '' ?>' required>
				   			</div>
				   		</div>
				   		<div class="row">
				   			<div class="col-md-12">
